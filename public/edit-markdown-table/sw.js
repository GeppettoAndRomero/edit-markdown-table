...
const CACHE_NAME = 'edit-markdown-table-v1';
const RUNTIME_CACHE = 'edit-markdown-table-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/edit-markdown-table/',
  '/edit-markdown-table/manifest.json',
  '/edit-markdown-table/icon-192.png',
  '/edit-markdown-table/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/edit-markdown-table/manifest.json';
}
